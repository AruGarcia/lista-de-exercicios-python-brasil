...
def cadastrar_usuario(nome: str, idade: int, salario: float, sexo: str, estado_civil: str):
    ...
    while True:
        ...
        if not 0 < idade <= 150:
            ...
            pass
        if not salario > 0:
            print('Erro: o salário precisa ser positivo, não pode ser 0')
            erro += 1
        ...
        if sexo.lower() != 'm' and sexo.lower() != 'f':
            ...
            pass
        if estado_civil.lower() != 's' and estado_civil.lower() != 'c' and estado_civil.lower() != 'v' and estado_civil.lower() != 'd':
